...
public class SearchFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        String URL = "https://foodpicker-api-deploy.herokuapp.com/products/";
        ...
        JsonArrayRequest objectRequest = new JsonArrayRequest(Request.Method.GET, URL, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            //produkti = new JSONArray(response);
                            recyclerAdapter = new RecyclerAdapter(response);
                            recyclerView.setAdapter(recyclerAdapter);
                        }
                        catch (Exception e){
                            Log.i("TAG", "onResponse: nisam uspeo");
                        }
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast toast = Toast.makeText(getContext(), "Proverite internet konekciju", Toast.LENGTH_SHORT);
                toast.show();
            }
        });
        ...
        //recyclerAdapter = new RecyclerAdapter(produkti);
